      ...
      <section className="bg-white dark:bg-[#191C24]">
        <div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-12">
          ...
          <div className="flex flex-col mb-8 lg:mb-16 space-y-4 sm:flex-row sm:justify-center sm:space-y-0 sm:space-x-4">
            ...
            <a
              href="#"
              className="inline-flex gap-2 items-center justify-center items-center py-3 px-5 text-base font-medium text-center text-gray-900 rounded-lg border border-gray-300 hover:bg-gray-100 focus:ring-4 focus:ring-gray-100 dark:text-white dark:border-[#4af058] dark:hover:bg-gray-700 dark:focus:ring-gray-800"
            >
              go to app
              <FaArrowRightLong />
            </a>
